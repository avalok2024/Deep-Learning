...
print("Accuracy of Training data: ", str(training_data_accuracy * 100) + " %")

X_test_prediction = model.predict(X_test)
training_test_data_accuracy = accuracy_score(X_test_prediction, Y_test)

print("Accuracy of Testing data: ", str(training_test_data_accuracy * 100) + " %")

# Predicting System
'Making predicting system for input data'
